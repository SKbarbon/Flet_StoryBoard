...
from fletsb.widgets.All import all_widgets
import flet
import os
import json
import time
...
# * local imports
from fletsb.sections.left_section import leftSection
from fletsb.sections.preview_section import PreviewSection
from fletsb.sections.edit_section import editSection
from fletsb.engines.edit_widget_engine import EditWidgetsEngine
from fletsb.engines.edit_subwidgets_engine import EditSubWidgetsEngine
from fletsb.engines.suggesting_engine import SuggestingEngine
from fletsb.widgets.All import all_widgets
from fletsb.pages.settings import SettingsPage
from fletsb.engines.bardai_engine import BardapiSupport
...
class mainPage:
    ...
    def pages_browser(self):
        ...
        new_page_button = flet.Container(flet.Row([flet.Text("+ Page", size=12, color="black")], alignment="center"),
                                         on_click=ask_for_new_page_name,
        ...
        for p in self.dict_content["pages"]:
            ...
            ], alignment="center"), bgcolor=flet.colors.GREY_700, width=60, height=30, border_radius=12,
