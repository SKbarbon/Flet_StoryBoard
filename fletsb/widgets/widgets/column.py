...
class Column(object):
    ...
    def update(self, new_props: dict = None, new_sub_widgets: dict = None):
        ...
        c.scroll = props["scroll"]
        c.alignment = props["sub_widgets_alignment"]
        c.auto_scroll = props["auto_scroll_to_end"]
    ...
    def widgets_to_add_in(self, *args):
        """To show all widgets that are available to add to the Column."""
        for i in args:
        ...
        title = flet.Text("Widgets in Column", size=25, weight=flet.FontWeight.BOLD, color="white")
